...
| 03 |  [minishell](https://github.com/MargaridaIFM/minishell) | C | The aim of this project is create a shell similar to bash. | 96 | ✅ | 08/01/2025|
| 03 |  [Philosophers](https://github.com/MargaridaIFM/Philosophers) | C | The purpose of this project is to learn about threads, mutex, semaphores and how to work whithe shared memory. To learn about this concepts we need to solve the classic Dining Philosophers Problem. | | | |
